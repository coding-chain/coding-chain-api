...
namespace Application.Write.ParticipationsSessions
{
    ...
    public class RemoveFunctionFromParticipationHandler: IRequestHandler<RemoveFunctionParticipationSessionCommand, string>
    {
        private readonly IParticipationsSessionsRepository _repository;
        private readonly ICurrentUserService _userService;

        public RemoveFunctionFromParticipationHandler(IParticipationsSessionsRepository repository, ICurrentUserService userService, ITimeService timeService)
        {
            _repository = repository;
            _userService = userService;
        }

        public async Task<string> Handle(RemoveFunctionParticipationSessionCommand request, CancellationToken cancellationToken)
        {
