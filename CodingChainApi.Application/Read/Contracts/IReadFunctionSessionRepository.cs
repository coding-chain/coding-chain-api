...
namespace Application.Read.Contracts
{
    ...
    {
        public Task<IPagedList<FunctionSessionNavigation>> GetAllFunctionNavigationPaginated(GetParticipationSessionFunctionsPaginatedQuery paginationQuery);
        public Task<FunctionSessionNavigation?> GetOneFunctionNavigationByIdAsync(Guid participationId, Guid functionId);
